    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        <li class="col-xs-12 col-sm-3 link-item"><span>1</span><a href="index-2.php">Choose Your Location</a></li>
                        <li class="col-xs-12 col-sm-3 link-item active"><span>2</span><a href="restaurants.php">Choose Restaurant</a></li>
                        <li class="col-xs-12 col-sm-3 link-item"><span>3</span><a href="profile.php">Pick Your favorite food</a></li>
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3">
                            ...
                            <div class="widget clearfix">
                                ...
                                <div class="widget-body">
                                    <div class="range-slider m-b-10"> <span id="ex2CurrentSliderValLabel"> Filter by price:<span id="ex2SliderVal"><strong>200</strong></span>&#x20B9</span>
                                        <br>
                                        <input id="ex2" type="text" data-slider-min="100" data-slider-max="1000" data-slider-step="1" data-slider-value="200" /> </div>
                                </div>
                            </div>
                            <!-- end:Pricing widget -->
                            <div class="widget clearfix">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                        ...
                                        <div class="entry-dscr">
                                            <h5><a href="#"></a><?php echo $name;?></h5> <span>Burgers, American, Sandwiches, Fast Food, BBQ,urgers, American, Sandwiches <a href="#">...</a></span>
                                            <ul class="list-inline">
                                                <li class="list-inline-item"><i class="fa fa-check"></i> Min &#x20B9 100.0</li>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                        <div class="right-content bg-white">
                                            <div class="right-review">
                                                ...
                                                <p> 245 Reviews</p> <button type="submit" class="btn theme-btn-dash" name="btnRedirect">View Menu</button>< </div>
                                        </div>
                                        <input type="hidden" name="rt_nm" value="<?php echo $name;?>">
                                        <!-- end:right info -->
                                    </div>
                                </div>
                                <!--end:row -->
                            ...
                            <div class="bg-gray restaurant-entry">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                        ...
                                        <!-- end:Logo -->
                                        <div class="entry-dscr">
                                            <h5><a href="#">Thai Restaurant</a></h5> <span>Burgers, American, Sandwiches, Fast Food, BBQ,urgers, American, Sandwiches <a href="#">...</a></span>
                                            <ul class="list-inline">
                                                <li class="list-inline-item"><i class="fa fa-check"></i> Min &#x20B9 100.0</li>
                                                <li class="list-inline-item"><i class="fa fa-motorcycle"></i> 30 min</li>
                                            </ul>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                        <div class="right-content bg-white">
                                            <div class="right-review">
                                                <div class="rating-block"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                                <p> 245 Reviews</p> <a href="profile.php" class="btn theme-btn-dash">View Menu</a> </div>
                                        </div>
                                        <!-- end:right info -->
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: <a href="tel:+080000012222">+91 7218456399</a></h5> </div>
...
<!-- Mirrored from codenpixel.com/demo/foodpicky/restaurants.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Mar 2018 18:36:16 GMT -->
</html>