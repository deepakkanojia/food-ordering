...
{
    header("location: map_results.php");
}
else{
...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/wall.jpg">
                ...
                <div class="banner-form">
                    <form class="form-inline">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputAmount">Restaurant,Food....</label>
                            <div class="form-group">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <div class="location-match text-xs-center">
                                <div class="container"> <span>356 restaurants matched your location: <span class="primary-color">Pune , India -</span> </span>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="profile.php">The South"s Best Fried Chicken</a></h5>
                                                ...
                                                <div class="restaurant-block">
                                                    <div class="left">
                                                        <a class="pull-left" href="profile.php"> <img src="images/logo1.png" alt="Restaurant logo" /> </a>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="restaurant-block">
                                                    <div class="left">
                                                        <a class="pull-left" href="profile.php"> <img src="images/logo2.png" alt="Restaurant logo" /> </a>
                                                        <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                                                    </div>
                                                    <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="restaurant-block">
                                                    <div class="left">
                                                        <a class="pull-left" href="profile.php"> <img src="images/logo3.png" alt="Restaurant logo" /> </a>
                                                        <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                                                    </div>
                                                    <div class="right-like-part pull-right"> <i class="fa fa-heart-o"></i> <span>48</span> </div>
                                                </div>
                                    ...
                                    <div class="tg-lightbox-content">
                                        ...
                                        <form>
                                            <fieldset>
                                                ...
                                                <div class="formgroup">
                                                    <i class="fa fa-exclamation-circle"></i><span>Forget password</span>
                                                </div>
                                                <div class="formgroup">
                                                    <button class="tg-btn tg-btn-lg" type="submit" id="btnLogin">login now</button>
                                                </div>
                                                <div class="formgroup">
                                                ...
                                                <div class="tg-signupwith">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-circle btn-lg"><i class="glyphicon glyphicon-list"></i>f</button>
                                                    <button type="button" class="btn btn-danger btn-circle btn-lg"><i class="glyphicon glyphicon-link"></i>g+</button>
                                                                ...
                                                                <div class="restaurant-wrap">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                                            <h5><a href="profile.php">Maenaam Thai Restaurant</a></h5> <span>Burgers, American, Sandwiches, Fast Food, BBQ</span>
